...
def Exp2():
    ...
    axs[plot_idx].grid(which='both',axis='x',color='k',linestyle=':')
    axs[plot_idx].axis([time[0],time[-1],0.4,1.2])
    axs[plot_idx].set_yticks([0.4,0.8,1.2])
    axs[plot_idx].set_yticklabels(labels=['0.4','0.8','1.2'],fontweight='light')
    axs[plot_idx].set_xticks(xticks)
